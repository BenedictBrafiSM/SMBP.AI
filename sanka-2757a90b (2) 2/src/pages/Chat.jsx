...
import { Send, Sparkles, Plus, Loader2, Mic, Paperclip, MoreVertical } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center h-full text-center px-4 py-12">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mb-2">Let's Get to Business

            </h2>
              <p className="text-slate-600 mb-8 max-w-md text-sm leading-relaxed">I am here to help you with your everyday business needs.
